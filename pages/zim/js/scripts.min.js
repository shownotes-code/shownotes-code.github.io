...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function openModal(modal) {
        ...
        modal.closest('.modal-wrap').classList.add('active');
    }
    ...
    function closeModal(modal) {
        ...
        modal.closest('.modal-wrap').classList.remove('active');
    }



    $('[data-phone-validation]').mask(settings.phonePlaceholder);

});

$('[data-modal-callback-send]').click(function () {
    let f = $(this).closest('form');

   let i = f.find('input').val();
   let t = f.find('textarea').val();

    Utils.hideErrorForElement(form.phoneInput);
    let number = i.val();

    if (!Utils.carrierValid(number)) {
        Utils.displayErrorForElement(i, "error.phone.carrier");
        return;
    }

    if (!Utils.validatePhoneNumber(number)) {
        Utils.displayErrorForElement(i, "error.phone.number");
        return;
    }
...
class Utils {
    ...
    static validatePhoneNumber(value) {
        ...
        return value.match(settings.regexPhoneNumber) !== null;
    }

    static carrierValid(val) {
        return settings.allowedCarriers.includes(val.slice(5,8));
    }
    ...
    static displayErrorForElement(element, i18key) {
        let parent = element.parent();
        let span = $("<span>").addClass(styles.errormessage.spanClass).attr('data-i18n', i18key);
        element.addClass(styles.errormessage.inputClass);
        parent.append(span);
        $(span).localize();
    }

    static hideErrorForElement(element) {
        let parent = element.parent();
        element.removeClass(styles.errormessage.inputClass);
        parent.find('span.' + styles.errormessage.spanClass).remove();
    }
}
...
var aboutSwiper = new Swiper('.swiper-container.project', {
...
var aboutSwiper = new Swiper('.swiper-container.project-gallery', {
...
var swiper = new Swiper('.swiper-container.project-about', {
    speed: 600,
    autoHeight: true,
    parallax: true,
    navigation: {
...
$(function () {
    $("[data-toggle-menu]").click(function () {
        if ($('.nav-bar__list').css('display') ===  'none') {
...
//=== OPEN FILTERS ON PROJECTS PAGE
$(function () {
    $("[data-filters-btn]").click(function () {
        $('.filters-block__list').toggleClass("active");
    });
});


//=== OPEN FILTERS ON PRESS CENTER PAGE
$(function () {
    $("[data-btn-press-center]").click(function () {
        $('.press-center__filter-list').toggleClass("active");
    });
});
