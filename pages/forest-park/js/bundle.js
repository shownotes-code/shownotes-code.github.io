...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    value: function initListeners() {
      ...
      (0, _jquery["default"])(document).on('click', '[data-nav-bar-btn]', function () {
      ...
      (0, _jquery["default"])('.modal-body__label-input').mask(_constants.settings.phonePlaceholder); //open menu in mobile view
      ...
      (0, _jquery["default"])(document).on('submit', '#callBack', function (e) {
        e.preventDefault();
        var form = (0, _jquery["default"])('#conForm');
        var formElem = {
          phoneInput: form.find('input'),
          ariaText: form.find('textarea')
        };
        var number = formElem.phoneInput.val();

        if (!_utils.Utils.carrierValid(number)) {
          (0, _jquery["default"])('.js-span-error').addClass('active');
          return;
        }
        ...
        _jquery["default"].ajax({
          ...
          success: function success(msg) {
            formElem.phoneInput.val('');
            formElem.ariaText.val('');
            (0, _jquery["default"])('.js-span-error').removeClass('active');
      ...
      (0, _jquery["default"])(document).on('submit', '#conForm', function (e) {
        e.preventDefault();
        var form = (0, _jquery["default"])('#conForm');
        var formElem = {
          phoneInput: form.find('input'),
        ...
        //     $('.js-span-error').removeClass('active');
        //     formElem.phoneInput.val('');
        //     $('.js-span-value-error').removeClass('active');
        //     formElem.ariaText.val('');
        // }
        //
        // f()
  ...
  _createClass(DialogService, null, [{
    ...
    value: function Show(templateName) {
      ...
      return new Promise(function (resolve, reject) {
        _jquery["default"].get('/wp-content/themes/forestTheme/' + templateName + '.modal.html', function (html) {
