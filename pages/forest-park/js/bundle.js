...
exports.settings = exports.styles = void 0;
var styles = {
  errormessage: {
    spanClass: 'js-span-error',
    inputClass: 'js-input-error',
    buttonError: 'js-button-error'
  },
  dialog: {
    id: 'modal',
    main: 'modal',
...
var settings = {
  allowedCarriers: ["063", "073", "066", "067", "069", "093", "095", "096", "097", "098", "099"],
  regexPhoneNumber: /^\+38\s(\()?(063|073|066|067|069|093|095|096|097|098|099)(\))\s\d{3}(-)?\d{2}(-)\d{2}$/,
...
var _fullpage2 = _interopRequireDefault(require("./fullpage/fullpage.min"));
...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    key: "fancy",
    value: function fancy(config) {
      _jquery["default"].fancybox.open(config);
    }
  }, {
    key: "fullpage",
    value: function fullpage(config) {
      new _fullpage2["default"]('#fullpage', config);
    }
  }, {
    key: "jumpTo",
    value: function jumpTo(target) {
      (0, _jump["default"])(target);
    }
  }, {
    key: "initListeners",
    value: function initListeners() {
      ...
      _this.actions = {
        showRequestACall: this.showRequestACall
      };
      (0, _jquery["default"])(document).on('click', "[data-action='modal']", function () {
        console.log('handle action modal');

        _dialogService.DialogService.Show((0, _jquery["default"])(this).attr('data-modal-template'));
      });
      (0, _jquery["default"])(document).on('click', "[data-action='modal-close']", function () {
        _dialogService.DialogService.Close();
      });
      (0, _jquery["default"])(document).on('click', '[data-nav-bar-btn]', function (e) {
        (0, _jquery["default"])(this).siblings('.nav-bar__links-list').toggle();
        (0, _jquery["default"])('.nav-bar__links-list').not((0, _jquery["default"])(this).siblings()).hide();
      });
      var sliderWrap = document.querySelector('#fullpage');
      ...
      function lol() {
        var gamno = document.queryCommandState('.aside__btn');
      }

      (0, _jquery["default"])('.aside__btn').click(function () {
        (0, _jquery["default"])('#fp-nav').toggleClass('open');
        (0, _jquery["default"])('.aside__btn-wrap').toggleClass('active');
      });
      setTimeout(checkClass, 0);
      sliderWrap.addEventListener('scroll', function () {
        var aside = document.querySelector('.content-main-second-block__aside');
        var inner = document.querySelector('.content-main-second-block__inner');
        var list = document.querySelector('.content-main-second-block__list');
        console.log('scroll');
      });
      (0, _jquery["default"])(document).ready(function () {
        (0, _jquery["default"])(window).bind('mousewheel DOMMouseScroll MozMousePixelScroll', function (event) {
          var delta = parseInt(event.originalEvent.wheelDelta || -event.originalEvent.detail);
          var sliderWrap = document.querySelector('#fullpage');
          var item = sliderWrap.children;
          var aside = document.querySelector('#fp-nav ');
          var asideBtnWrap = document.querySelector('.aside__btn-wrap');
          ...
          if (delta >= 0) {
            ...
            if (item[0].classList.contains("active")) {
              ...
              asideBtnWrap.classList.remove('show');
            } else {
              aside.classList.add('show');
              asideBtnWrap.classList.add('show');
            }
          } else {
            console.log('Вниз');
      ...
      (0, _jquery["default"])('html').click(function () {
        (0, _jquery["default"])('.nav-bar__links-list').hide();
      });
      (0, _jquery["default"])(document).on('click', "[data-action='method']", function () {
        console.log('handle action method');
        var method = (0, _jquery["default"])(this).attr('data-method');

        if (_this.actions.hasOwnProperty(method)) {
          _this.actions[method]((0, _jquery["default"])(this));
        }
      });
      (0, _jquery["default"])('[data-logo-menu-btn]').click(function () {
        (0, _jquery["default"])('.nav-bar--mobile').toggleClass('active');
      });
      ...
      (0, _jquery["default"])('.content__link').click(function (e) {
        e.preventDefault();
        window.app.jumpTo('#content-main-second-block');
      }); //open menu in mobile view

      document.querySelector("[data-head-menu]").addEventListener('click', function () {
        this.classList.toggle('active');
        (0, _jquery["default"])('body').toggleClass('body-stop');
      }); ////scroll item for slider in header
      // $('[data-scroll-item-btn]').click(function (e) {
      //     e.preventDefault();
      //
      //     let thisHash = $(this).prop("hash");
      //     window.app.jumpTo(thisHash);
      //     $('.nav-bar__links-list').hide();
      // });
      //scroll item for slider in mobile menu

      (0, _jquery["default"])('[data-head-mobile-btn]').click(function (e) {
        e.preventDefault();
        (0, _jquery["default"])('.nav-bar--mobile.active').toggleClass('active');
        (0, _jquery["default"])('[data-head-menu]').toggleClass('active');
        (0, _jquery["default"])('body').toggleClass('body-stop');
      });
    ...
    value: function showRequestACall() {
      _dialogService.DialogService.Show('request-a-call').then(function (dialog) {
        var form = {
          phoneInput: dialog.find('input'),
          timeSelect: dialog.find('select'),
          submitButton: dialog.find('button')
        };
        form.phoneInput.mask(_constants.settings.phonePlaceholder);
        var time = round((0, _moment["default"])());
        var end = (0, _moment["default"])().set(_constants.settings.workTime);

        while (end.diff(time) >= 0) {
          var val = time.format('HH:mm');
          var opt = (0, _jquery["default"])("<option>").val(val).text(val);
          form.timeSelect.append(opt);
          time.add(_constants.settings.showInterval, 'minutes');
        }
        ...
        function submitForm() {
          console.log({
            ...
            requestTime: (0, _moment["default"])().format()
          });
...
},{"./constants":4,"./fullpage/fullpage.min":5,"./phonemask":7,"./services/dialogService":8,"./utils":9,"jquery":1,"jump.js":2,"moment":3}],7:[function(require,module,exports){
"use strict";
...
var DialogService = /*#__PURE__*/function () {
  ...
  _createClass(DialogService, null, [{
    key: "Show",
    value: function Show(templateName) {
      var dialog = (0, _jquery["default"])("#" + _constants.styles.dialog.id);
      var content;

      if (dialog.length === 0) {
        content = (0, _jquery["default"])("<div>").addClass(_constants.styles.dialog.content);
        dialog = (0, _jquery["default"])("<div>").attr('id', _constants.styles.dialog.id).addClass(_constants.styles.dialog.main);
        (0, _jquery["default"])('body').append(dialog);
      } else {
        content = (0, _jquery["default"])("." + _constants.styles.dialog.content);
        content.empty();
      }

      var header = (0, _jquery["default"])('<div>').addClass(_constants.styles.dialog.header);
      var body = (0, _jquery["default"])('<div>').addClass(_constants.styles.dialog.body);
      var closeBtn = (0, _jquery["default"])("<button>").addClass(_constants.styles.dialog.close).attr("data-action", "modal-close").html('<svg width="16" height="16" viewBox="0 0 16 16" fill="none">\n' + '<line y1="-1" x2="19.0277" y2="-1" transform="matrix(0.682022 0.731332 -0.682022 0.731332 1 2.00049)" stroke="white" stroke-width="2"/>\n' + '<line y1="-1" x2="19.0274" y2="-1" transform="matrix(0.683226 -0.730207 0.683226 0.730207 2 15.894)" stroke="white" stroke-width="2"/>\n' + '</svg>');
      closeBtn.on('click', DialogService.Close);
      dialog.on('click', function (e) {
        if ((0, _jquery["default"])(e.target).attr('id') === _constants.styles.dialog.id) {
          DialogService.Close();
        }
      });
      return new Promise(function (resolve, reject) {
        _jquery["default"].get('./pages/' + templateName + '.modal.html', function (html) {
    ...
    value: function Close() {
      (0, _jquery["default"])("#" + _constants.styles.dialog.id).remove();
    }
  }]);
...
},{"./../constants":4,"jquery":1}],9:[function(require,module,exports){
"use strict";
...
var Utils = /*#__PURE__*/function () {
  ...
  _createClass(Utils, null, [{
    ...
    value: function validatePhoneNumber(value) {
      return value.match(_constants.settings.regexPhoneNumber) !== null;
    }
  }, {
    key: "carrierValid",
    value: function carrierValid(val) {
      return _constants.settings.allowedCarriers.includes(val.slice(5, 8));
    }
  }, {
    ...
    key: "displayErrorForElement",
    value: function displayErrorForElement(element, i18key) {
      var parent = element.parent();
      var span = (0, _jquery["default"])("<span>").addClass(_constants.styles.errormessage.spanClass);
      element.addClass(_constants.styles.errormessage.inputClass);
      parent.append(span);
    }
  }, {
    key: "hideErrorForElement",
    value: function hideErrorForElement(element) {
      var parent = element.parent();
      element.removeClass(_constants.styles.errormessage.inputClass);
      parent.find('span.' + _constants.styles.errormessage.spanClass).remove();
    }
  }]);
